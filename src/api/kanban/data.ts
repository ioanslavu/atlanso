  ...
  tasks: [
    {
      ...
      name: 'Call with sales of Tiriac Auto'
    },
    {
      ...
      columnId: '5e849c39325dc5ef58e5a5db',
      comments: [],
      description: 'We are looking for experienced sales manager',
      due: addDays(now, 6).getTime(),
      isSubscribed: true,
      labels: [],
      name: 'Interview for the new model of Dacia. Sales Manager'
    },
    {
      ...
      isSubscribed: false,
      labels: [],
      name: 'Change the details in contract.'
    },
    {
      ...
      isSubscribed: false,
      labels: [],
      name: 'Integrate the new Blockchain API'
    },
    {
      ...
      isSubscribed: true,
      labels: [],
      name: 'Redesign the logo of the company'
    },
    {
      ...
      isSubscribed: true,
      labels: [],
      name: 'Fire the new intern which was late again'
    }
  ]
};
